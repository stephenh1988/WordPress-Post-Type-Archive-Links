...
class Harris_Post_Type_Archive_Link {
	...
	public function metabox() {
		...
		<div id="post-type-archives-menu-items">
			<ul id="post-type-archives-menu-item-checklist">
			...
			<p class="button-controls">
				<span class="add-to-menu">
					<input type="submit"<?php disabled( $nav_menu_selected_id, 0 ); ?> class="button-secondary submit-add-to-menu" value="<?php esc_attr_e( 'Add to Menu' ); ?>" name="add-post-type-archives-menu-item" id="submit-post-type-archives" />
				</span>
			</p>
		</div><!-- #post-type-archives-menu-items -->
